...
$text_data = [
	...
	'tab_04' => ['デザート', 'Dessert'],
	'info_h' => ['店舗情報', 'Info'],
	'info_p' => ['数学カフェは、おしゃれな町並みのなかにあります。駅チカで、立ち寄りやすくなっています。aaaaaaaaaaaaaaaa', 'The math cafe is located in a fashionable street. It\'s easy to stop by at Chika Station＊＊＊＊＊暫定です＊＊＊＊＊'],
